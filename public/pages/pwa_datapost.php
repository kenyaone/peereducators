...
if ($action === 'cloud_sync') {
    ...
    $payload = json_encode(['api_key'=>(defined('CLOUD_API_KEY') ? CLOUD_API_KEY : ''),'device_id'=>$cfg['school_id']??'peereducator-unknown','synced_at'=>date('Y-m-d H:i:s'),'schools'=>$schoolRows,'poll_summary'=>pollSummary()]);
